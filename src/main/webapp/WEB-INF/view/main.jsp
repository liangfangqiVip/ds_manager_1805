...
<div data-options="region:'west',title:'West',split:true"
    ...
    <div id="aa" class="easyui-accordion" fit="true">
        <div title="商品管理" data-options="iconCls:'icon-save'" style="overflow:auto;padding:10px;">
            <a href="javascript:addTabs('toSpuPage.do','商品Spu管理')">商品Spu管理</a>
            <br>
            <a href="javascript:addTabs('toAttrPage.do','商品Attr管理')">商品Attr管理</a>
            <br>
            <a href="javascript:addTabs('toSkuPage.do','商品Sku管理')">商品Sku管理</a>
        </div>
    </div>
</div>
